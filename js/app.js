...
if (document.querySelector('.main-slider__body')) {
	new Swiper('.main-slider__body', {
		...
		// Arrows
		navigation: {
			nextEl: '.main-slider__control .control-main-slider__arrow_next',
			prevEl: '.main-slider__control .control-main-slider__arrow_prev',
		}
	});
}

if (document.querySelector('.pt-slider__body')) {
	new Swiper('.pt-slider__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 3,
		spaceBetween: 32,
		...
		// Arrows
		navigation: {
			nextEl: '.pt-slider__arrows .pt-slider-arrow_next',
			prevEl: '.pt-slider__arrows .pt-slider-arrow_prev',
		},
		breakpoints: {
...
if (document.querySelector('.slider-blog__body')) {
	new Swiper('.slider-blog__body', {
		...
		// Arrows
		navigation: {
			nextEl: '.slider-blog__arrows .slider-blog-arrow_next',
			prevEl: '.slider-blog__arrows .slider-blog-arrow_prev',
		},
		breakpoints: {
			// when window width is >= 320px
			320: {
...
window.onload = function () {
    ...
    function documentActions(e) {
        ...
        if (targetElement.classList.contains('promo-btn-fp')) {
            const productId = targetElement.closest('.item-product-fp').dataset.pid;
        ...
        if (targetElement.classList.contains('cart-header__icon') || targetElement.closest('.cart-header__icon')) {
            ...
            e.preventDefault();
        } else if (!targetElement.closest('.cart-header') && !targetElement.classList.contains('promo-btn-fp')) {
    ...
    function loadProducts(data) {
        const productsItems = document.querySelector('.products__items-fp');
...
`;
    ...
    function addToCart(productButton, productId) {
        if (!productButton.classList.contains('_hold')) {
            ...
            const productImage = product.querySelector('.item-product__image-fp');
    ...
    function updateCart(productButton, productId, productAdd = true) {
        ...
        if (productAdd) {
            ...
            if (!cartProduct) {
                const product = document.querySelector(`[data-pid="${productId}"]`);
                const cartProductImage = product.querySelector('.item-product__image-fp').innerHTML;
                const cartProductTitle = product.querySelector('.item-product__title-fp').innerHTML;
